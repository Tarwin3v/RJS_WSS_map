...
//@q https://www.apollographql.com/docs/apollo-server/data/subscriptions/
...
//@q context ::  The context argument is useful for passing things that any resolver might need, like authentication scope, database connections, and custom fetch functions
...
module.exports = {
  ...
  //@d we add a Subscription resolver that returns an AsyncIterator, which listens to the events asynchronously
  Subscription: {
    pinAdded: {
